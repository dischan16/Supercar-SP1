...
// if(isset($_SESSION["loggedin"]) && $_SESSION["admin_loggedin"] === true){
...
<body>
                <h2 class="uk-modal-title uk-text-small uk-alert-danger" style="text-align: center" uk-alert>BIENVENUE SUR L'ADMIN SUPERCAR</h2>
                <div class="uk-container">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <!-- <p class="text-center">Vous n’avez pas de compte? <a href="register_admin.php">Inscrivez-vous dès maintenant</a></p> -->
