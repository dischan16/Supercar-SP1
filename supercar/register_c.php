    ...
    <div class="uk-container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group" >
                ...
                <input type="reset" class="uk-button uk-button-danger uk-align-center" value="Réinitialiser">
            </div> -->

            <p class="text-center">Vous avez déjà un compte ? <a href="login_c.php">Connectez-vous ici</a></p>
