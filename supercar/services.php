	...
	?>
		...
		<div class="uk-section">
			<div class="uk-container">
				...
				<h2 style="text-align: center; padding-bottom:30px; font-size: 38.7px;"><?php echo $title; ?></h2>

				<div class="uk-grid-match uk-child-width-1-1@m" uk-grid>
					<div>
						<form class="uk-form-horizontal uk-margin-large" action="" method="" name="">

							<?php echo '<img src="upload/' . $row['images'] . '" width="400px" height="400px" class="rounded mx-auto d-block img-fluid" alt="Image">' ?>

							<div class="uk-child-width-1-2@s" uk-alert>

								<div class="uk-card uk-card-muted uk-card-body uk-width-1-1">
									<div><?php echo $p1; ?></div> <br>
									<div><?php echo $p2; ?></div> <br>
									<div><?php echo $p3; ?></div>
